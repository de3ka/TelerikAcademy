...
{
    using _01_03.Student._01.Student.StudentModel;
    ...
    public class Demo
    {
        ...
        {
            var student1 = new Student("Radka Goshova Toshova", "Kaspichan", "0885044568", "radka@gmail.com", "amthdunnowhut", 2, UniversityType.SofiaUniversity, FacultyType.Mathematics, SpecialtyType.AppliedMathematics);
            var student2 = new Student("Pesho Goranov Todorov", "Zli Dol", "0885044568", "pesho@gmail.com", "smthdunnowhut", 2, UniversityType.UNSS, FacultyType.Economics, SpecialtyType.MicroEconomics);
            var student3 = new Student("Stamat Gospodinov Mitev", "Zverino", "0885044338", "stamat@gmail.com", "smthdunnowhut", 2, UniversityType.TUSofia, FacultyType.IT, SpecialtyType.JavaProgrammer);
            var student4 = new Student("Kostadinka Peeva Draganova", "Seslavci", "0885033568", "kostadinka@gmail.com", "amthdunnowhut", 2, UniversityType.NBU, FacultyType.Law, SpecialtyType.PublicLaw);
            var student5 = new Student("Pesho Goshov Toshov", "Vyrshec", "0885055568", "pesho@gmail.com", "amthdunnowhut", 2, UniversityType.SofiaUniversity, FacultyType.Literature, SpecialtyType.EnglishLiterature);
            var student6 = new Student("Conka Miteva Spasova", "Dupnica", "0887944538", "conka@gmail.com", "amthdunnowhut", 2, UniversityType.TUSofia, FacultyType.IT,SpecialtyType.CSharpProgrammer);
            ...
            var student7 = (Student)student6.Clone();
            ...
            var students = new Student[] {student6,student5,student4, student3, student2, student1 }.OrderBy(x => x).ToArray();

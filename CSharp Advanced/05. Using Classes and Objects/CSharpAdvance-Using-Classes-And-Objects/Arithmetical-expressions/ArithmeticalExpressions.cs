...
namespace Arithmetical_expressions
{
    public class ArithmeticalExpressions
    {
        ...
        private static List<string> SeparateTokens(string expression)
        {
        ...
        private static Queue<string> ConvertToReversePolishNotation(List<string> tokens)
        {
        ...
        private static void PutInvariantCulture()
        {
            Thread.CurrentThread.CurrentCulture = CultureInfo.InvariantCulture;
        }

        private static double GetResultFromRPN(Queue<string> queue)
        {

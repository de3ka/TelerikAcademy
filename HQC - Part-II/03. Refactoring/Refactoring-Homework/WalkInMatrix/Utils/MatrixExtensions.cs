...
namespace WalkInMatrix.Utils
{
    ...
    {
        public static IPosition FindFirstCellPositionWithValue(this Matrix matrix, int value)
        {
        ...
        public static bool IsPositionValid(this Matrix matrix, IPosition position)
        {
        ...
        public static bool CheckIfAnyNeighbourCellContainsValue(this Matrix matrix, IPosition position, int value)
        {
